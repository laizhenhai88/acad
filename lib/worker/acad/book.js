...
const loadBookedId = async (task) => {
  ...
  let res = await axios({
    ...
    data: 'COID=1416742&start=%22' + task.params.book.date + '+00%3A00%22&__=GetStudentLessonsByTime'
  })
