...
module.exports = {
  ...
  async doTask(task) {
    ...
    try {
      let addDay = Math.floor(Math.random() * 5) + 10
      ...
      let res = await axios({
        ...
        data: 'index=0&coid=1416742&start=%22' + day + '+18%3A00%22&classtool=7&sex=-1&hascamera=-1&personality=%22%22&teachstyle=%22%22&__=NewGetTutorByTime'
      })
